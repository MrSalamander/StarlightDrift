...
void menuu (Texture2D* bck,Texture2D* nave,float* vol,Texture2D* fundo,Sound* menu)
{
   PlaySound(*menu);   
   while(1)
        {
...
int main(void)
{
    ...
    menu=LoadSound("/raylib/StarlightDrift/sounds/Main Menu.mp3");
